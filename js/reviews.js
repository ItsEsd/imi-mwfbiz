...
"<div align='right'><button class='delcombtn' onclick='delrvcomment(this)'>Delete Review <svg xmlns='http://www.w3.org/2000/svg' fill='currentColor' class='bi bi-trash3' viewBox='0 0 16 16'>"+
...
function delrvcomment(label){
    ...
    var x = document.getElementsByClassName('rvcmntid');
         ...
         console.log(cmntid);
         var ur1="https://script.google.com/macros/s/";
         var ur2="AKfycbxPr1k5w2MRyb9RieX_LMyZySi2YE7ED-QdhiNPlgbT61UhY6W01RSPhdf01eZznfWheg";
